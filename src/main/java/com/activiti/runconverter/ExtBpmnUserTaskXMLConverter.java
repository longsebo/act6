...
public class ExtBpmnUserTaskXMLConverter extends BaseBpmnXMLConverter {
    ...
    public ExtBpmnUserTaskXMLConverter() {
...
//                xtr);
        ...
        parseChildElements(getXMLElementName(),userTask,model,xtr);
        //循环扩展节点,放到属性里头
        ...
        for(String key:extensionElements.keySet()){
            ...
            if(!extensionElementList.isEmpty()){
                ...
                userTask.addAttribute(extendAttribute);
            }
        }
